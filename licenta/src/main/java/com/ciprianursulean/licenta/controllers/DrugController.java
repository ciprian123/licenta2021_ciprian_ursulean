...
public class DrugController {
    ...
    public ResponseEntity<List<Date>> getDrugDateOfUsage(@RequestParam("name") String drugName) {
        return new ResponseEntity<>(drugService.getDrugUsageDates(drugName), HttpStatus.OK);
    }
